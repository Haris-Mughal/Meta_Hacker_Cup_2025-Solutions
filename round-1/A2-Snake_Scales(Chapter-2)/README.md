This problem shares similarities with chapter 1. Chapter 2 involves the ground, and larger bounds.

Solid Snake is back at work scaling Metal Platforms! This time, he is bringing his own ladder.

Solid Snake needs to inspect N platforms, numbered 1 to N. The i-th platform is a horizontal line segment from points (i,Ai) to (i+1,Ai), inclusive. He can travel between two platforms with a ladder of height h or greater if there exists a vertical line segment of length h that intersects both platforms.
